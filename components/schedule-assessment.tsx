...
<div className="text-black">
    ...
    <div className="space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <button
                className={`flex items-center justify-center gap-2 bg-blue-100 rounded px-4 py-3 text-black hover:bg-blue-300 ${selectedCompany === "microsoft" ? "border-2 border-green-500" : ""
                    }`}
        ...
        {/* Info Box */}
        <div className="bg-blue-300 rounded-lg p-4 flex items-center justify-start gap-3">
        ...
        <div className="space-y-4">
            <div>
                <label className="block mb-2 font-bold">Select Country</label>
            ...
            <div>
                <label className="block mb-2 font-bold">Select Zip Code</label>
                <div className="relative">
                    <select className="w-full  rounded px-4 py-3 text-black appearance-none focus:outline-none">
            ...
            <div>
                <label className="block mb-2 font-bold">Select Testing Centre</label>
                <div className="relative">
                    <select className="w-full  rounded px-4 py-3 text-black appearance-none focus:outline-none">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    <label className="block mb-2 font-bold">Select a Date</label>
                ...
                <div className="w-full">
                    <label className="block mb-2 text-sm text-gray-700 font-bold">Select Time</label>
